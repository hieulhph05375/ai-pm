...
- [ENH] Global Category Integration across Projects, Tasks, Risks, Stakeholders, and Holidays.
- [ENH] Support dynamic colors and icons for all system categories.
- [FIX] Project-level stakeholder roles migrated to Category system.
- [UI] Pagination options expanded to 100 and 200 items.
